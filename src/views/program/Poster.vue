<template>
    <div class="general call">
        <section class="title">
            <div class="container">
                <div class="col-12">
                    <h1 class="documentTitle">Accepted Short Papers</h1>
                </div>
            </div>
        </section>
        ...
        <section class="body">
            <div class="container">
                <div class="col-12">
                    <div id="accordion">
                        <div class="card" v-for="(paper, key) in poster" :key="key">
                            <div class="card-header">
                                <h5>
                                    <a class="paper" href="#" data-toggle="collapse" :data-target="`#collapse${key}`">
                                        {{paper.title}}
                                    </a>
                                </h5>
